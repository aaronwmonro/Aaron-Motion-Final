...
lineTL.fromTo(".lines",{drawSVG:"0%"}, {duration: 1, drawSVG:"100% 85%"})
.fromTo(".lines-2",{drawSVG:"0%"}, {duration: 1, drawSVG:"100% 90%"}, "-=.75")
.fromTo(".lines-3",{drawSVG:"0%"}, {duration: .9, drawSVG:"100% 96%"}, "-=.75")
.to(".to-red",{duration:.5, stroke: "#009ADA", ease: "none"}, "-=1")
.to(".line",{duration:.5, opacity: 0}, "-=.75")
.to("#circle",{duration:.5, opacity: 1}, "-=.7")
.from("#circle", {drawSVG:"95% 85%", rotate: 450, duration: 1, ease: "none"}, "-=.6")
...
.from("#bmw-top-left",{duration:.75, rotate: 360, opacity: 0}, "bmw")
.from("#bmw-top-right",{duration:.75, rotate: 360, opacity: 0}, "bmw")
.from("#bmw-bottom-right",{duration:.75,  rotate: 0, opacity: 0}, "bmw")
.from("#bmw-bottom-left",{duration:.75, rotate: 0, opacity: 0}, "bmw")
